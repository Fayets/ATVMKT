...
export type AgendaPickerStep = 'menu' | 'reel' | 'historia'
...
type Props = {
  open: boolean
  onClose: () => void
  /** True si el lead ya tiene un punto de agenda guardado (mostrar opción de quitar). */
...
export function AgendaPointPickerModal({
  ...
  return (
    <Modal open={open} onClose={() => !saving && onClose()} title="Punto de agenda" maxWidth="720px">
      {step === 'menu' && (
